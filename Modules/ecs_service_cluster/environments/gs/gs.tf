...
module "ecs_service_cluster" {
    ...
    az_count                        = 4
    ecs_service-min_size            = 1
    ecs_service-max_size            = 2
    ecs_service-desired_capacity    = 1
}
...
output "ecs_instance_role_arn" {
    description = ""
    value       = module.ecs_service_cluster.ecs_instance_role_arn
}
...
output "vpc_id" {
    description = ""
    value       = module.ecs_service_cluster.vpc_id
}
